...
def generate_model(X_shape: int, y_shape: int | tuple) -> models.Model:
    model = models.Sequential([
        ...
        layers.LSTM(X_shape * 5, return_sequences=True, name='lstm_8x'),
        layers.LSTM(X_shape * 7, return_sequences=True, name='lstm_4x'),
        layers.LSTM(X_shape * 9, return_sequences=True, name='lstm_2x'),
